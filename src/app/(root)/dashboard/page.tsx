  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[58%_42%] flex-grow mt-4 gap-4 mx-4 sm:mx-6 lg:mx-0">
        <div
          className="border shadow rounded-md h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-y-hidden p-4">
        ...
        <div
          className="border shadow rounded-md h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-y-hidden p-4 lg:mr-4">
                ...
                <div key={document.id} className="flex items-center pb-2 my-4 last:mb-0">
                  <div className="flex-shrink-0 mr-4">
                    <Avatar>
                      ...
                      />
                      <AvatarFallback
                        className="h-[40px] w-[40px] bg-[#891C69] border border-[#974D7B] rounded-full flex items-center justify-center text-white">
