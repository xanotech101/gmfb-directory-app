...
const analytics = [
  { name: 'Departments', total: 50, icon: UsersIcon, increase: '+20% from last month' },
  { name: 'Documents', total: 123, icon: DocumentDuplicateIcon, increase: '+20% from last month' },
  { name: 'Users', total: 623, icon: UserGroupIcon, increase: '+20% from last month' },
  { name: 'Announcements', total: 65, icon: BellAlertIcon, increase: '+20% from last month' },
]
      ...
      <div className="h-full flex flex-col">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-4 mx-4 sm:mx-6 lg:mx-0">
          {analytics.map((item, index) => (
            <div
              key={index}
              className="h-auto p-4 border shadow-lg rounded-md overflow-hidden flex flex-col justify-between"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[58%_42%] flex-grow mt-4 gap-4 mx-4 sm:mx-6 lg:mx-0">
          <div className="border shadow-lg rounded-md h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-y-auto p-4">
            ...
            {announcements.length > 0 ? (
              ...
              <p className="text-gray-500">No announcements available.</p> // Fallback message if no announcements
            )}
          </div>{' '}
          <div className="border shadow-lg rounded-md h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-y-auto p-4 lg:mr-4">
